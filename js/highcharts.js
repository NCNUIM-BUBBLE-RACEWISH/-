...
(function(C, Y) { typeof module === "object" && module.exports ? module.exports = C.document ? Y(C) : Y : C.Highcharts = Y(C) })(typeof window !== "undefined" ? window : this, function(C) {
    ...
    function $(a, b, c, d, e) { a = z.createElement(a);
        b && v(a, b);
    ...
    function Wa(a, b, c, d) { this.axis = a;
        this.pos = b;
        this.type = c || "";
    ...
    qb.prototype = {
        ...
        run: function(a, b, c) {
            ...
            if (e() &&
                ...
                Fa.length || clearInterval(e.timerId) }, 13)
        },
        step: function(a) {
            var b = +new oa,
                c, d = this.options;
            ...
            if (c.attr && !c.element) c = !1;
                ...
                a && e && e.call(c);
                c = !1 } else this.pos = d.easing((b - this.startTime) / f), this.now = this.start + (this.end - this.start) *
    ...
    Ra = function(a, b, c) {
        ...
        var a = p(a, "%Y-%m-%d %H:%M:%S"),
            ...
            j = O.lang,
            m = j.weekdays,
            d = v({ a: m[g].substr(0, 3), A: m[g], d: Ka(h), e: h, w: g, b: j.shortMonths[i], B: j.months[i], m: Ka(i + 1), y: k.toString().substr(2, 2), Y: k, H: Ka(f), k: f, I: Ka(f % 12 || 12), l: f % 12 || 12, M: Ka(d[ub]()), p: f < 12 ? "AM" : "PM", P: f < 12 ? "am" : "pm", S: Ka(d.getSeconds()), L: Ka(A(b % 1E3), 3) }, u.dateFormats);
        for (e in d)
    ...
    O = {
        ...
        global: { useUTC: !0, canvasToolsURL: "http://code.highcharts.com/modules/canvas-tools.js", VMLRadialGradientURL: "http://code.highcharts.com/4.2.1/gfx/vml-radial-gradient.png" },
        chart: {
            borderColor: "#4572A7",
            borderRadius: 0,
        ...
        plotOptions: {
            line: {
                ...
                dataLabels: { align: "center", formatter: function() {
                        return this.y === null ? "" : u.numberFormat(this.y, -1) }, style: { color: "contrast", fontSize: "11px", fontWeight: "bold", textShadow: "0 0 6px contrast, 0 0 3px contrast" }, verticalAlign: "bottom", x: 0, y: 0, padding: 5 },
                cropThreshold: 300,
                pointRange: 0,
                softThreshold: !0,
    ...
    ia.prototype = {
        parsers: [{ regex: /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/, parse: function(a) {
                return [F(a[1]), F(a[2]), F(a[3]), parseFloat(a[4], 10)] } }, { regex: /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/, parse: function(a) {
    ...
    Q.prototype = {
        ...
        init: function(a, b) { this.element = b === "span" ? $(b) : z.createElementNS(Ea, b);
            this.renderer = a },
        animate: function(a,
            b, c) { b = p(b, this.renderer.globalAnimation, !0);
            Pa(this);
            if (b) { b = D(b, {});
                if (c) b.complete = c;
                Xa(this, a, b) } else this.attr(a, null, c);
            return this },
        colorGradient: function(a, b, c) {
            ...
            if (f) {
                ...
                r = r.join(",");
                i[r] ? n = i[r].attr("id") : (g.id = n = "highcharts-" + Ab++, i[r] = k = d.createElement(f).attr(g).add(d.defs), k.radAttr = h, k.stops = [], o(j, function(a) { a[1].indexOf("rgba") === 0 ? (e = ia(a[1]), m = e.get("rgb"), l = e.get("a")) : (m = a[1], l = 1);
        ...
        on: function(a, b) {
            var c = this,
                d = c.element;
            db && a === "click" ? (d.ontouchstart = function(a) { c.touchEventFired = oa.now();
                a.preventDefault();
    ...
    Ba.prototype = {
        ...
        init: function(a, b, c, d, e, f) {
            ...
            this.setSize(b, c, !1);
            var h;
            if (Na && a.getBoundingClientRect) this.subPixelFix = b = function() { M(a, { left: 0, top: 0 });
                h = a.getBoundingClientRect();
                M(a, { left: ua(h.left) - h.left + "px", top: ua(h.top) - h.top + "px" }) }, b(), N(C, "resize",
                b)
        },
        getStyle: function(a) {
                            ...
                            if (e !== " ") {
                                ...
                                if (m) {
                                    for (var n = e.replace(/([^\^])-/g, "$1- ").split(" "), X = g.length > 1 || f || n.length > 1 && j.whiteSpace !== "nowrap", o, w, q, s = [], v = y(r), B = 1, A = a.rotation, u = e, D = u.length;
                                        ...
                                        "")], r.removeChild(r.firstChild))) : !o || n.length === 1 ? (n = s, s = [], n.length && (B++, r = z.createElementNS(Ea, "tspan"), L(r, { dy: v, x: k }), p && L(r, "style", p), b.appendChild(r)), q > m && (m = q)) : (r.removeChild(r.firstChild), s.unshift(n.pop())), n.length && r.appendChild(z.createTextNode(n.join(" ").replace(/- /g, "-")));
        ...
        button: function(a,
            ...
            var k = this.label(a, b, c, i, null, null, null, null, "button"),
                j = 0,
                m, l, n, t, r, p, a = { x1: 0, y1: 0, x2: 0, y2: 1 },
            ...
            p = h.style;
            delete h.style;
            N(k.element, za ? "mouseover" : "mouseenter", function() { j !== 3 && k.attr(f).css(t) });
            N(k.element, za ? "mouseout" : "mouseleave", function() { j !== 3 && (m = [e, f, g][j], l = [n, t, r][j], k.attr(m).css(l)) });
            k.setState = function(a) {
                (k.state = j = a) ? a === 2 ? k.attr(g).css(r) : a === 3 && k.attr(h).css(p): k.attr(e).css(n) };
            return k.on("click", function(a) { j !== 3 && d.call(k, a) }).attr(e).css(v({ cursor: "default" }, n))
        },
        ...
        circle: function(a, b, c) { a = Z(a) ? a : { x: a, y: b, r: c };
        ...
        rect: function(a,
            ...
            var e = Z(a) ? a.r : e,
                ...
                a = Z(a) ? a : a === B ? {} : { x: a, y: b, width: s(c, 0), height: s(d, 0) };
        ...
        symbol: function(a, b, c, d, e, f) {
            ...
            }, k = a.match(i)[1], a = Nb[k] || f && f.width && f.height && [f.width, f.height], g = this.image(k).attr({ x: b, y: c }), g.isImg = !0, a ? j(g, a) : (g.attr({ width: 0, height: 0 }), $("img", { onload: function() { this.width === 0 && (M(this, { position: "absolute", top: "-999em" }), z.body.appendChild(this));
                    j(g, Nb[k] = [this.width, this.height]);
                    this.parentNode && this.parentNode.removeChild(this) }, src: k }));
            return g
        },
        symbols: {
        ...
        label: function(a, b, c, d, e, f, g, h, i) {
            ...
            E = function() {
                ...
                m.x = b;
                m.y = c };
            C = function(a, b) { l ? l.attr(a, b) : gb[a] = b };
            j.onAdd = function() {
                m.add(j);
                j.attr({
                    text: a || a === 0 ? a : "",
            ...
            j.xSetter = function(a) { j.x = a;
                ...
                w = A(a);
                j.attr("translateX", w) };
            j.ySetter = function(a) { s = j.y = A(a);
                j.attr("translateY", s) };
            var F = j.css;
            return v(j, {
                css: function(a) {
                    if (a) {
                        var b = {},
                            a = D(a);
                        o(j.textProps, function(c) { a[c] !== B && (b[c] = a[c], delete a[c]) });
                        m.css(b) }
                    return F.call(j, a) },
                getBBox: function() {
                ...
                destroy: function() { U(j.element, "mouseenter");
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    if (n !== this.cTT) { m = a.fontMetrics(b.style.fontSize).b;
                    ...
                    if (b = a.div, !b) {
                        ...
                        o(k.reverse(), function(a) {
                            ...
                            v(a, { translateXSetter: function(b, c) { d.left = b + "px";
                                    ...
                                    a[c] = b;
                                    a.doTransform = !0 } });
                            o(["opacity", "visibility"], function(b) { fb(a, b + "Setter", function(a, b, c, e) { a.call(this, b, c, e);
                                    d[c] = b }) })
                        })
                    }
                } else b = c;
        ...
        K = {
            ...
            clip: function(a) {
                var b =
                    this,
                    c;
                a ? (c = a.members, ma(c, b), c.push(b), b.destroyClip = function() { ma(c, b) }, a = a.getCSS(b)) : (b.destroyClip && b.destroyClip(), a = { clip: mb ? "inherit" : "rect(auto)" });
                return b.css(a)
            },
            ...
            updateShadows: va,
            setAttr: function(a, b) { mb ? this.element[a] = b : this.element.setAttribute(a, b) },
        ...
        var Cb = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    w[0] < 1 && a.push([1, w[1]]);
                    o(a, function(a, b) { g.test(a[1]) ? (f = ia(a[1]), j = f.get("rgb"), m = f.get("a")) : (j = a[1], m = 1);
                        q.push(a[0] * 100 + "% " + j);
                        b ? (r = m, p = j) : (t = m, y = j) });
                    if (c === "fill")
    ...
    Ba.prototype.measureSpanWidth = function(a, b) {
        ...
        return d };
    var Ob;
    if (ha) u.CanVGRenderer = K = function() { Ea = "http://www.w3.org/1999/xhtml" }, K.prototype.symbols = {}, Ob = function() {
        function a() {
            var a =
                b.length,
                d;
    ...
    Wa.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (t) {
                ...
                if (m === B) { m = { stroke: r, "stroke-width": t };
                    if (o) m.dashstyle = o;
                    if (!h) m.zIndex = 1;
                    if (b) m.opacity = 0;
            ...
            if (l && y) w === "inside" && (y = -y), d.opposite && (y = -y), h = this.getMarkPath(u, v, y, l * A, g, f), n ? n.animate({ d: h, opacity: c }) : this.mark = f.path(h).attr({ stroke: x, "stroke-width": l, opacity: c }).add(d.axisGroup);
    ...
    u.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (q(p)) x.zIndex = p;
            if (l)
                if (n) l.show(), l.animate({ d: n });
                else {
                    if (l.hide(), f) a.label = f = f.destroy() }
            else if (n && n.length && (a.svgElem = l = w.path(n).attr(x).add(), o))
                for (t in d = function(b) { l.on(b, function(c) { o[b].apply(a, [c]) }) }, o) d(t);
            if (e && q(e.text) && n && n.length && b.width > 0 && b.height > 0 && !n.flat) {
                ...
                if (!f) { x = { align: e.textAlign || e.align, rotation: e.rotation };
                    if (q(p)) x.zIndex = p;
        ...
        destroy: function() { ma(this.axis.plotLinesAndBands, this);
            delete this.axis;
            Ta(this) }
    };
    ...
    ja.prototype = {
        ...
        defaultYAxisOptions: { endOnTick: !0, gridLineWidth: 1, tickPixelInterval: 72, showLastLabel: !0, labels: { x: -8, y: 3 }, lineWidth: 0, maxPadding: 0.05, minPadding: 0.05, startOnTick: !0, title: { rotation: 270, text: "Values" }, stackLabels: { enabled: !1, formatter: function() {
                    return u.numberFormat(this.total, -1) }, style: D(ba.line.dataLabels.style, { color: "#000000" }) } },
        ...
        setOptions: function(a) { this.options = D(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], D(O[this.coll], a)) },
        ...
        getSeriesExtremes: function() {
            ...
            o(a.series, function(c) {
                if (c.visible ||
                    ...
                    a.isLog && e <= 0 && (e = null);
                    if (a.isXAxis) {
                        if (d = c.xData, d.length) a.dataMin = E(p(a.dataMin, d[0]), Sa(d)), a.dataMax = s(p(a.dataMax, d[0]), Da(d)) } else { c.getExtremes();
                        f = c.dataMax;
                        c = c.dataMin;
        ...
        getMinorTickPositions: function() {
            ...
            if (g && g / c < this.len / 3)
                if (this.isLog) { f = b.length;
                    for (e = 1; e < f; e++) d = d.concat(this.getLogTickPositions(c, b[e - 1], b[e], !0)) } else if (this.isDatetimeAxis && a.minorTickInterval === "auto") d = d.concat(this.getTimeTicks(this.normalizeTimeTickInterval(c),
                e, f, a.startOfWeek));
            else
        ...
        adjustForMinRange: function() {
            var a = this.options,
                ...
                f, g, h, i, k, j;
            if (this.isXAxis && this.minRange === B && !this.isLog) q(a.min) || q(a.max) ? this.minRange = null : (o(this.series, function(a) { i = a.xData;
                for (g = k = a.xIncrement ? 1 : i.length - 1; g > 0; g--)
                    if (h = i[g] - i[g - 1], f === B || h < f) f = h }), this.minRange = E(f * 5, this.dataMax - this.dataMin));
        ...
        setAxisTranslation: function(a) {
            ...
            if (j || i || d)
                if (h ? (f = h.minPointOffset, g = h.pointRangePadding) : (o(b.series, function(a) {
                        ...
                        d = s(d, c);
                        b.single || (f = s(f, ya(a) ? 0 : c / 2), g = s(g, a === "on" ? 0 : c)) })), h = b.ordinalSlope && e ? b.ordinalSlope / e : 1, b.minPointOffset = f *= h, b.pointRangePadding = g *= h, b.pointRange = E(d, c), j) b.closestPointRange = e;
            if (a) b.oldTransA = k;
        ...
        renderUnsquish: function() {
            ...
            if (this.autoRotation) o(c, function(a) {
                if ((a = d[a]) && a.labelLength > l) l = a.labelLength }), l > i && l > h.h ? k.rotation = this.labelRotation : this.labelRotation = 0;
            else if (g && (m = { width: i + "px" }, !j)) { m.textOverflow = "clip";
                for (n = c.length; !f && n--;)
                    if (t = c[n], i = d[t].label)
                        if (i.styles.textOverflow === "ellipsis" && i.css({ textOverflow: "clip" }), i.getBBox().height > this.len / c.length - (h.h - h.f) || d[t].labelLength > g) i.specCss = { textOverflow: "ellipsis" } }
            if (k.rotation &&
        ...
        getOffset: function() {
            ...
            if (k || a.isLinked) {
                if (o(e, function(b) { f[b] ? f[b].addLabel() : f[b] = new Wa(a, b) }), a.renderUnsquish(), r.reserveSpace !== !1 && (h === 0 || h === 2 || { 1: "left", 3: "right" }[h] === a.labelAlign || a.labelAlign === "center") && o(e, function(a) { X = s(f[a].getLabelSize(), X) }), a.staggerLines) X *= a.staggerLines, a.labelOffset = X * (a.opposite ? -1 : 1) } else
            ...
            if (t && t.text && t.enabled !== !1) {
                if (!a.axisTitle) a.axisTitle = c.text(t.text, 0, 0, t.useHTML).attr({
                    ...
                    rotation: t.rotation ||
                        0,
                    align: t.textAlign || { low: y ? "right" : "left", middle: "center", high: y ? "left" : "right" }[t.align]
        ...
        render: function() {
            ...
            if (a.hasData() || f) {
                a.minorTickInterval && !a.categories && o(a.getMinorTickPositions(), function(b) { k[b] || (k[b] = new Wa(a, b, "minor"));
                ...
                l && o(g, function(c, d) { s = g[d + 1] !== B ? g[d + 1] + n : a.max - n;
                    if (d % 2 === 0 && c < a.max && s <= a.max + (b.polar ? -n : n)) j[c] || (j[c] = new u.PlotLineOrBand(a)), w = c + n, j[c].options = { from: e ? la(w) : w, to: e ? la(s) : s, color: l }, j[c].render(), j[c].isActive = !0 });
            ...
            if (t) r = a.getLinePath(t), a.axisLine ? a.axisLine.animate({ d: r }) : a.axisLine = c.path(r).attr({ stroke: d.lineColor, "stroke-width": t, zIndex: 7 }).add(a.axisGroup), a.axisLine[y ? "show" : "hide"](!0);
        ...
        destroy: function(a) {
            ...
            o([b.ticks, b.minorTicks, b.alternateBands], function(a) { Ta(a) });
    ...
    ja.prototype.getTimeTicks = function(a, b, c, d) {
        ...
        if (q(b)) {
            ...
            e.push(d);
            o(Oa(e, function(a) {
                return k <= G.hour && a % G.day === n }), function(a) { f[a] = "day" })
        }
    ...
    ja.prototype.getLogTickPositions = function(a, b, c, d) {
        ...
        if (a >= 0.5) a = A(a), g = this.getLinearTickPositions(a, b, c);
            ...
            for (var f = S(b), h, i, k, j, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) { i = e.length;
                for (h = 0; h < i && !m; h++) k = Ca(la(f) * e[h]), k > b && (!d || j <= c) && j !== B && g.push(j), j > c && (m = !0), j = k } else if (b = la(b), c = la(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = p(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length :
                    f) || 1)), a = tb(a, null, sb(a)), g = Ha(this.getLinearTickPositions(a, b, c), Ca), !d) this._minorAutoInterval = a / 5;
        if (!d) this.tickInterval = a;
        return g
    };
    var Pb = u.Tooltip = function() { this.init.apply(this, arguments) };
    Pb.prototype = {
        init: function(a, b) {
            var c = b.borderWidth,
                d = b.style,
        ...
        hide: function(a) {
            ...
            if (!this.isHidden) this.hideTimer = Qa(function() { b.label[a ? "fadeOut" : "hide"]();
                b.isHidden = !0 }, a) },
        ...
        getPosition: function(a, b, c) {
            var d = this.chart,
                ...
                n = function(a) {
                    ...
                    k = b;
                    h = a },
                t = function() { m.apply(0, i) !== !1 ? l.apply(0, k) === !1 && !h && (n(!0), t()) : h ? f.x = f.y = 0 : (n(!0), t()) };
        ...
        refresh: function(a, b) {
            ...
            k === !1 ? this.hide() : (this.isHidden && (Pa(d), d.attr("opacity", 1).show()), d.attr({ text: k }), m = e.borderColor || a.color || i.color || "#606060", d.attr({ stroke: m }), this.updatePosition({ plotX: f, plotY: g, negative: a.negative, ttBelow: a.ttBelow, h: h[2] || 0 }), this.isHidden = !1);
    ...
    var Ya = u.Pointer = function(a, b) { this.init(a, b) };
    Ya.prototype = {
        init: function(a, b) {
            var c = b.chart,
                d = c.events,
        ...
        runPointActions: function(a) {
            ...
            g && (e ? g.noSharedTooltip :
                g.directTouch) && f ? n = f : (o(c, function(b) { k = b.noSharedTooltip && e;
                j = !e && b.directTouch;
                b.visible && !k && !j && p(b.options.enableMouseTracking, !0) && (t = b.searchPoint(a, !k && b.kdDimensions === 1)) && l.push(t) }), o(l, function(a) { m = !e && a.series.kdDimensions === 1 ? a.dist : a.distX;
            ...
            if (!this._onDocumentMouseMove) this._onDocumentMouseMove = function(a) {
                if (W[ra]) W[ra].pointer.onDocumentMouseMove(a) }, N(z, "mousemove", this._onDocumentMouseMove);
            ...
            if (!l || !l.touch)
                if (d < h ? d = h : d > h + k && (d = h + k), e < i ? e = i : e > i + j && (e = i + j), this.hasDragged = Math.sqrt(Math.pow(n - d, 2) + Math.pow(t - e, 2)), this.hasDragged > 10) {
                    ...
                    if (b.hasCartesianSeries && (this.zoomX || this.zoomY) && m && !r &&
                        !l) this.selectionMarker = l = b.renderer.rect(h, i, f ? 1 : k, g ? 1 : j, 0).attr({ fill: c.selectionMarkerFill || "rgba(69,114,167,0.25)", zIndex: 7 }).add();
            ...
            if (this.selectionMarker) {
                ...
                if (this.hasDragged || d) o(c.axes, function(c) {
                    if (c.zoomEnabled && q(c.min) && (d || b[{ xAxis: "zoomX", yAxis: "zoomY" }[c.coll]])) {
                        ...
                        j = !0 } }), j && H(c, "selection", e, function(a) { c.zoom(v(a, d ? { animation: !1 } : null)) });
        ...
        onContainerMouseDown: function(a) { a = this.normalize(a);
            ...
            this.dragStart(a) },
        onDocumentMouseUp: function(a) { W[ra] && W[ra].pointer.drop(a) },
        ...
        setDOMEvents: function() {
            ...
            if (db) b.ontouchstart = function(b) { a.onContainerTouchStart(b) }, b.ontouchmove = function(b) { a.onContainerTouchMove(b) }, eb === 1 && N(z, "touchend", a.onDocumentTouchEnd)
        },
        destroy: function() {
            var a;
    ...
    v(u.Pointer.prototype, {
        ...
        pinchTranslateDirection: function(a, b, c, d, e, f, g, h) {
            var i = this.chart,
                ...
                v = !w && b[1][m],
                u = !w && c[1][m],
                A, c = function() {!w && P(q - v) > 20 && (p = h || P(s - u) / P(q - v));
                    r = (n - s) / p + q;
        ...
        onDocumentTouchEnd: function(a) { W[ra] && W[ra].pointer.drop(a) }
    });
    if (C.PointerEvent || C.MSPointerEvent) {
        ...
        v(Ya.prototype, {
            onContainerPointerDown: function(a) { Eb(a, "onContainerTouchStart", "touchstart", function(a) { wa[a.pointerId] = { pageX: a.pageX, pageY: a.pageY, target: a.currentTarget } }) },
            ...
            onDocumentPointerUp: function(a) { Eb(a, "onDocumentTouchEnd", "touchend", function(a) { delete wa[a.pointerId] }) },
        ...
        fb(Ya.prototype, "init", function(a, b, c) { a.call(this, b, c);
            this.hasZoom && M(b.container, { "-ms-touch-action": "none", "touch-action": "none" }) });
        fb(Ya.prototype, "setDOMEvents", function(a) { a.apply(this);
            (this.hasZoom || this.followTouchMove) && this.batchMSEvents(N) });
        fb(Ya.prototype, "destroy", function(a) { this.batchMSEvents(U);
            a.call(this) })
    }
    var pb = u.Legend = function(a, b) { this.init(a, b) };
    pb.prototype = {
        init: function(a, b) {
            var c = this,
                d = b.itemStyle,
        ...
        adjustMargins: function(a,
            ...
            this.display && !d.floating && o([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function(f, g) { f.test(e) && !q(a[g]) && (c[ob[g]] = s(c[ob[g]], c.legend[(g + 1) % 2 ? "legendHeight" : "legendWidth"] + [1, -1, -1, 1][g] * d[g % 2 ? "x" : "y"] + p(d.margin, 12) + b[g])) }) },
        render: function() {
            var a = this,
                b = a.chart,
                c = b.renderer,
            ...
            if (m || l) {
                if (i) {
                    if (g > 0 && h > 0) i[i.isNew ? "attr" : "animate"](i.crisp({ width: g, height: h })), i.isNew = !1 } else a.box = i = c.rect(0, 0, g, h, k.borderRadius, m || 0).attr({ stroke: k.borderColor, "stroke-width": m || 0, fill: l || "none" }).add(d).shadow(k.shadow), i.isNew = !0;
                i[f ? "show" : "hide"]() }
            a.legendWidth = g;
            a.legendHeight = h;
        ...
        handleOverflow: function(a) {
            ...
            if (a > f) {
                ...
                y(h);
                if (!l) this.nav = l = d.g().attr({ zIndex: 1 }).add(this.group), this.up = d.symbol("triangle", 0, 0, m, m).on("click", function() { b.scroll(-1, j) }).add(l), this.pager = d.text("", 15, 10).css(k.style).add(l), this.down =
                    d.symbol("triangle-down", 0, 0, m, m).on("click", function() { b.scroll(1, j) }).add(l);
                b.scroll(0);
                a = f
    ...
    (/Trident\/7\.0/.test(Aa) || Na) && fb(pb.prototype, "positionItem",
        function(a, b) {
            ...
            d();
            setTimeout(d) });
    var hb = u.Chart = function() { this.getArgs.apply(this, arguments) };
    ...
    hb.prototype = {
        ...
        redraw: function(a) {
            ...
            i && (o(b, function(a) { a.isDirty && (k = !0) }), o(b, function(a) {
                var b = a.min + "," + a.max;
                if (a.extKey !== b) a.extKey = b, p.push(function() { H(a, "afterSetExtremes", v(a.eventArgs, a.getExtremes()));
                    delete a.eventArgs });
                (k || g) && a.redraw() }));
            k && this.drawChartBox();
        ...
        getAxes: function() {
            ...
            c = c.concat(b);
            o(c, function(b) { new ja(a, b) })
        },
        getSelectedPoints: function() {
            var a = [];
            o(this.series, function(b) { a = a.concat(Oa(b.points || [], function(a) {
                    return a.selected })) });
            return a },
        ...
        cloneRenderTo: function(a) {
            var b = this.renderToClone,
                c = this.container;
            a ? b && (this.renderTo.appendChild(c), Ua(b), delete this.renderToClone) : (c && c.parentNode === this.renderTo && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), M(b, { position: "absolute", top: "-9999px", display: "block" }), b.style.setProperty &&
        ...
        getContainer: function() {
            ...
            d = this.chartWidth;
            e = this.chartHeight;
            this.container = a = $(Ma, { className: "highcharts-container" + (c.className ? " " + c.className : ""), id: f }, v({ position: "relative", overflow: "hidden", width: d + "px", height: e + "px", textAlign: "left", lineHeight: "normal", zIndex: 0, "-webkit-tap-highlight-color": "rgba(0,0,0,0)" }, c.style), this.renderToClone || a);
        ...
        initReflow: function() {
            ...
            N(C, "resize", b);
            N(a, "destroy", function() { U(C, "resize", b) })
        },
        setSize: function(a, b, c) {
            var d = this,
                e, f, g = d.renderer;
            ...
            H(d, "resize");
            a = g.globalAnimation;
            Qa(function() { d && H(d, "endResize", null, function() { d.isResizing -= 1 }) }, a === !1 ? 0 : a && a.duration || 500)
        },
        ...
        resetMargins: function() {
            var a =
                this;
            o(ob, function(b, c) { a[b] = p(a.margin[c], a.spacing[c]) });
        ...
        drawChartBox: function() {
            ...
            s ? s.animate({ width: v.width, height: v.height }) : this.clipRect =
                b.clipRect(v);
            if (l) g ? g.animate(g.crisp({ x: p, y: o, width: q, height: y, strokeWidth: -l })) : this.plotBorder = b.rect(p, o, q, y, 0, -l).attr({ stroke: a.plotBorderColor, "stroke-width": l, fill: "none", zIndex: 1 }).add();
            this.isDirtyBox = !1
        },
        ...
        isReadyToRender: function() {
            var a = this;
            return !da && C == C.top && z.readyState !== "complete" || ha && !C.canvg ? (ha ? Ob.push(function() { a.firstRender() }, a.options.global.canvasToolsURL) : z.attachEvent("onreadystatechange", function() { z.detachEvent("onreadystatechange", a.firstRender);
        ...
        firstRender: function() {
            ...
            if (a.isReadyToRender()) {
                ...
                a.renderer.draw();
                c && c.apply(a, [a]);
                o(a.callbacks, function(b) { a.index !== B && b.apply(a, [a]) });
                H(a, "load");
                a.cloneRenderTo(!0)
            }
        },
    ...
    R.prototype = {
        ...
        bindAxes: function() {
            ...
            o(a.axisTypes || [], function(e) { o(c[e], function(c) { d = c.options;
                    if (b[e] === d.index || b[e] !== B && b[e] === d.id || b[e] === B && d.index === 0) c.series.push(a), a[e] = c, c.isDirty = !0 });!a[e] && a.optionalAxis !== e && Y(18, !0) }) },
        ...
        getSegments: function() {
            ...
            if (e)
                if (this.options.connectNulls) {
                    ...
                    d.length && (b = [d]) } else o(d, function(c,
                    g) { c.y === null ? (g > a + 1 && b.push(d.slice(a + 1, g)), a = g) : g === e - 1 && b.push(d.slice(a + 1, g + 1)) });
            this.segments = b
        },
        ...
        setData: function(a, b, c, d) {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData &&
                e.visible) o(a, function(a, b) { f[b].update && a !== i.data[b] && f[b].update(a, !1, null, !1) });
            else {
                e.xIncrement = null;
                e.colorCounter = 0;
                ...
                if (n && h > n) {
                    ...
                    if (ka(j)) { l = p(i.pointStart, 0);
                        j = p(i.pointInterval, 1);
                        for (c = 0; c < h; c++) t[c] = l, r[c] = a[c], l += j;
                        e.xIncrement = l } else if (Ja(j))
                        if (s)
            ...
            if (m.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = S(g.plotX), e = g.plotY, j = g.graphic, n = g.marker || {}, o = !!g.marker, a = s && n.enabled === B || n.enabled, r = g.isInside, a && e !== B && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || l, h = a.r, i = p(n.symbol, this.symbol), k = i.indexOf("url") === 0, j) j[r ? "show" : "hide"](!0).animate(v({ x: d - h, y: e - h }, j.symbolName ? { width: 2 * h, height: 2 * h } : {}));
                        else {
        ...
        applyZones: function() {
            ...
            if (d.length && (i || k) && m.min !== B) i && i.hide(), k && k.hide(),
                l = m.getExtremes(), o(d, function(d, o) {
                    ...
                    x = s(e, f);
                    if (m.isXAxis) {
                        if (h = { x: t ? x : y, y: 0, width: q, height: j }, !r) h.x = b.plotHeight - h.x } else if (h = { x: 0, y: t ? x : y, width: j, height: q }, r) h.y = b.plotWidth - h.y;
                    b.inverted && c.isVML && (h = m.isXAxis ? { x: 0, y: n ? y : x, height: h.width, width: b.chartWidth } : { x: h.y - b.plotLeft - b.spacingBox.x, y: 0, width: h.height, height: b.chartHeight });
                    g[o] ?
        ...
        invertGroups: function() {
            ...
            var b = this,
                c = b.chart;
            if (b.xAxis) N(c, "resize", a), N(b, "destroy", function() { U(c, "resize", a) }), a(), b.invertGroups = a },
        ...
        buildKDTree: function() {
            ...
            Qa(function() {
                var d = Oa(b.points || [], function(a) {
                    return a.y !== null });
                b.kdTree = a(d, c, c) }, b.options.kdNow ? 0 : 1) },
    ...
    v(hb.prototype, {
        ...
        showLoading: function(a) {
            ...
            if (!d) b.loadingDiv = d = $(Ma, { className: "highcharts-loading" }, v(e.style, { zIndex: 10, display: "none" }), b.container), b.loadingSpan = $("span", null, e.labelStyle, d), N(b, "redraw", f);
                    ...
                    if (!m || h[b] && h[b].y !== null)
                        if (h[b]) c.push(h[b]);
                            ...
                            for (n = a.index; n <= f.series.length; n++)
                                if (l = a.getStackIndicator(null, b, n), j = g[b].points[l.key]) { d = j[1];
                                    break }
                            i = e.translate(b);
                            k = f.getThreshold(d);
    ...
    I.scatter = sa;
    ba.pie = D(ea, { borderColor: "#FFFFFF", borderWidth: 1, center: [null, null], clip: !1, colorByPoint: !0, dataLabels: { distance: 30, enabled: !0, formatter: function() {
    ...
    ea = {
        ...
        translate: function(a) {
            ...
            this.getX = function(b, c) { h = V.asin(E((b - a[1]) / (a[2] / 2 + m), 1));
    ...
    R.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d), k = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex ||
            6), p(d.defer, !0) && (k.attr({ opacity: +h }), h || N(a, "afterAnimate", function() { a.visible && k.show();
            ...
            if (n && !h) e.dataLabel = n.destroy();
                ...
                else if (q(i)) { n = { fill: d.backgroundColor, stroke: d.borderColor, "stroke-width": d.borderWidth, r: d.borderRadius || 0, rotation: h, padding: d.padding, zIndex: 1 };
    ...
    R.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (m) d = v({ x: g ? f.plotWidth - i : h, y: A(g ? f.plotHeight - h : i), width: 0, height: 0 }, d), v(c, { width: k.width, height: k.height }), c.rotation ? (a = f.renderer.rotCorr(j, c.rotation), b[e ? "attr" : "animate"]({
            x: d.x +
                c.x + d.width / 2 + a.x,
    ...
    if (I.pie) I.pie.prototype.drawDataLabels = function() {
        ...
        if (a.visible && (e.enabled || a._hasPointLabels)) {
            ...
            o(b, function(a) { a.dataLabel && a.visible && B[a.half].push(a) });
            for (F = 2; F--;) {
                var H = [],
                    N = [],
                    I = B[F],
    ...
    ea = u.TrackerMixin = {
        ...
        drawTrackerGraph: function() {
            ...
            k ? k.attr({ d: d }) : (a.tracker = h.path(d).attr({ "stroke-linejoin": "round", visibility: a.visible ? "visible" : "hidden", stroke: p, fill: c ? p : "none", "stroke-width": b.lineWidth + (c ? 0 : 2 * i), zIndex: 2 }).add(a.group), o([a.tracker, a.markerGroup], function(a) { a.addClass("highcharts-tracker").on("mouseover", n).on("mouseout", function(a) { g.onTrackerMouseOut(a) }).css(m);
        ...
        setState: function(a, b) {
            ...
            if (!(a === this.state && !b || this.selected &&
                ...
                if ((c = f[a] && f[a].halo) && c.size) {
                    ...
                    n.attr(v({ fill: this.color || e.color, "fill-opacity": c.opacity }, c.attributes))[b ? "animate" : "attr"]({ d: this.haloPath(c.size) }) } else n && n.attr({ d: [] });
                this.state = a
            }
        },
        haloPath: function(a) {
    ...
    v(R.prototype, {
        ...
        select: function(a) { this.selected = a = a === B ? !this.selected : a;
            if (this.checkbox) this.checkbox.checked = a;
            H(this, a ? "select" : "unselect") },
        drawTracker: ea.drawTrackerGraph
    });
    v(u, { Color: ia, Point: Ia, Tick: Wa, Renderer: cb, SVGElement: Q, SVGRenderer: Ba, arrayMin: Sa, arrayMax: Da, charts: W, dateFormat: Ra, error: Y, format: La, pathAnim: void 0, getOptions: function() {
            return O }, hasBidiBug: Qb, isTouchDevice: Mb, setOptions: function(a) { O = D(!0, O, a);
            Fb();
            return O }, addEvent: N, removeEvent: U, createElement: $, discardElement: Ua, css: M, each: o, map: Ha, merge: D, splat: ta, stableSort: jb, extendClass: na, pInt: F, svg: da, canvas: ha, vml: !da && !ha, product: "Highcharts", version: "4.2.1" });
    return u
});
